...
// Consider a character spawned when it's inserted
void CCharacter::InsertInto(CGameWorld *pWorld)
{
...
void CCharacter::FireWeapon()
{
	...
	switch(m_ActiveWeapon)
	{
		...
		case WEAPON_LASER:
		{
			CLaser *pLaser = new CLaser(m_Pos,
				Direction,
...
void CCharacter::Snap(int SnappingClient)
{
	...
	if(!m_ReckoningTick || GameWorld()->IsPaused())
	{
